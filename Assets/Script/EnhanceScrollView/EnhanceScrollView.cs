...
public class EnhanceScrollView : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        Debug.Log("001 == pos : " + listEnhanceItems[mCenterIndex].GetComponent<RectTransform>().anchoredPosition.x.ToString() + "," + listEnhanceItems[mCenterIndex].GetComponent<RectTransform>().anchoredPosition.y.ToString());

        LerpTweenToTarget(0f, curHorizontalValue, false);

        Debug.Log("002 == pos : " + listEnhanceItems[mCenterIndex].GetComponent<RectTransform>().anchoredPosition.x.ToString() + "," + listEnhanceItems[mCenterIndex].GetComponent<RectTransform>().anchoredPosition.y.ToString());
